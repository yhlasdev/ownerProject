...
import { Box, IconButton, Typography, Drawer, Divider } from "@mui/material";
    ...
    return (
        <Box className='flex' sx={{ width: '100%', gap: 2 }}>
            <Box className='flex-1 flex flex-col justify-between'>
                <Box>
                    <Typography variant="h5" color="text.secondary"> Arzanyň gelen ýeri: </Typography>
                    <Typography variant="body1"> {receivedDocument?.place?.name} </Typography>
                </Box>
                <Box sx={{ mt: 2 }}>
                    <Typography variant="h5" color="text.secondary"> Arzanyň F.A.A </Typography>
            ...
            <Box className='flex-1 flex flex-col justify-between gap-2'>
                <Box>
                    <Typography variant="h5" color="text.secondary"> Gelen wagty: </Typography>
                    <Typography variant="body2">
                        {receivedDocument?.createdAt ? dayjs(receivedDocument.createdAt).format('DD.MM.YYYY') : '-'}
                    </Typography>
                </Box>
                <Box>
